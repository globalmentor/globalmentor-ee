...
public abstract class AbstractHTTPServlet<R extends Resource> extends BaseHTTPServlet //TODO address http://lists.w3.org/Archives/Public/w3c-dist-auth/1999OctDec/0343.html
{
	 ...
	 * @return <code>true</code> if the agent sending the request is not known to be redirect-averse.
	...
	/**
	 * Services the POST method. This version delegates to <code>doGet()</code>.
	 * @param request The HTTP request.
	 * @param response The HTTP response.
	 * @throws ServletException if there is a problem servicing the request.
	 * @throws IOException if there is an error reading or writing data.
	...
	*/
	 ...
	 * <li>The requested non-collection URI does not exist, but there exists a collection at the location of the URI with an appended '/'.</li>
	 * <li>The analogous resource, if present, is a collection.</li>
	 * </ul>
	 * @param request The HTTP request indicating the requested resource.
	 * @param requestedResourceURI The requested absolute URI of the resource.
	 * @param method The HTTP request method.
	 * @param analogousResourceURI The URI of a resource to use by analogy, or <code>null</code> if no analogous resource is known. This parameter is useful when
	...
	*/
	 ...
	 * read-only, in case it returns <code>null</code>.
	 * @param resourceURI The URI of the resource requested.
