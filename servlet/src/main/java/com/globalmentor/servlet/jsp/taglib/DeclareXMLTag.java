 ...
 * <p>
 * For XHTML media types, this tag sets the content type to "application/xhtml+xml" if the user agent supports it; otherwise, the content type "text/html" is
 * used. This is to allow XHTML content to be sent to Microsoft Internet Explorer, which doesn't work with XHTML served as "application/xhtml+xml".
 * </p>
 * <p>
 * This tag also generates an XML declaration and document type.
 * </p>
 * <dl>
 * <dt>publicID</dt>
 ...
 * 
 * <dt>systemID</dt>
 * <dd>The doctype system ID. If not present, defaults to the default system ID for the given public ID. Required if the public ID is not recognized by this
 * implementation and a document type declaration is desired.</dd>
 * 
 * <dt>contentType</dt>
 * <dd>The document content type. Defaults to the appropriate content type for the given document type, if recognized; otherwise, defaults to "text/xml".</dd>
 * 
 * <dt>rootElement</dt>
 * <dd>The name of the root element of the document. Defaults to the appropriate root element for the content type, if recognized; otherwise, required.</dd>
 * </dl>
...
public class DeclareXMLTag extends TagSupport {
	...
	/**
	 * @return The document content type. Defaults to the appropriate content type if a recognized document type is requested; otherwise "text/xml".
	 * @see #getMediaType()
	 */
	...
	/**
	 * @return The name of the root element of the document. Defaults to the appropriate root element name if a recognized content type can be determined that has
	 *         a default root element; otherwise <code>null</code>.
	 */
	...
	/**
	 * @return The doctype system ID. Defaults to the appropriate system ID if a recognized document type is requested; otherwise <code>null</code>.
	 */
	 ...
	 * @param systemID The doctype public ID, or <code>null</code> if the system ID should be determined automatically from the public ID.
	 */
