...
/**
 * A <code>ValueBinding</code> subclass that allows a general <code>Expression</code> to be used wherever a <code>ValueBinding</code> instance is called for.
...
public class ExpressionValueBinding extends ValueBinding {
	...
	/**
	 * Return the (possibly <code>null</code>) expression string, with leading and trailing delimiters, from which this <code>ValueBinding</code> was built.
