 ...
 * <p>
 * Inspired by <code>com.sun.faces.renderkit.html_basic.HtmlBasicRenderer.java</code>.
 * </p>
...
public abstract class AbstractXHTMLRenderer extends Renderer {
	...
	{"accept", "accesskey", "alt", "bgcolor", "border", "cellpadding", "cellspacing", "charset", "cols", "coords", "dir", "enctype", "frame", "height",
			"hreflang", "lang", "longdesc", "maxlength", "onblur", "onchange", "onclick", "ondblclick", "onfocus", "onkeydown", "onkeypress", "onkeyup", "onload",
			"onmousedown", "onmousemove", "onmouseout", "onmouseover", "onmouseup", "onreset", "onselect", "onsubmit", "onunload", "rel", "rev", "rows", "rules",
			"shape", "size", "style", "summary", "tabindex", "target", "title", "usemap", "width"};

	/**
	 * This array contains attributes that have a boolean value in JSP, but have have no value in HTML. For example "disabled" or "readonly".
	 * <P>
	 *
	...
	*/
	...
	protected Set<String> getPassthroughAttributeSet() {
		return passthroughAttributeSet;
	}
	...
	/** @return The name of the XML element for the component. */
	protected String getComponentElementName() {
