...
/**
 * A parameter component with a formatted value. The format template syntax is identical to that of <code>MessageFormat</code>, and the value of each
 * <code>UIParameter</code> child will be used as a parameter to the template.
...
public class UIParameterFormat extends UIParameter {
	...
	/**
	 * @return The value of the component, after performing any necessary formatting.
	 */
