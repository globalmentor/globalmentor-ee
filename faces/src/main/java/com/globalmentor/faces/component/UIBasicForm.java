 ...
 * <p>
 * This class has the following enhancements:
 * </p>
 * <ul>
 ...
 * </ul>
 * <p>
 * This component currently does not support two forms on a page with <code>enctype="multipart/form-data".</code>
 * </p>
...
public class UIBasicForm extends UIForm implements Clogged {
	 ...
	 * component, all children of this component, and this component itself. This version checks to see if multipart content has been sent for this form and if
	 * so, processes decodes with a special <code>FacesContext</code> with the parameters from that multipart form submission.
	...
	/**
	 * A map of form fields that populates itself from a multipart request through its <code>FileItemFactory</code> interface.
	 * @author Garret Wilson
	 */
	private static class MultipartFormFieldFactory extends DefaultFileItemFactory //TODO don't descend from DefaultFileItemFactory when DiskFileUpload is fixed to not require it
	{
		...
		protected FileItemFactory getDefaultFileItemFactory() {
			return defaultFileItemFactory;
		}

		/**
		 * Constructs a form field factory that populates a map with form fields.
		 * @param defaultFileItemFactory The factory to which to delegate for form fields.
		 */
