...
public class TableRenderer extends DataRenderer {
	...
	/**
	 * Determines the name of the XML element for a row in a column. This version returns <code>tr</code>.
	...
	/**
	 * Determines the name of the XML element for an item in a column. This version returns <code>ELEMENT_TD</code>.
	...
	/**
	 * Begins encoding the data. This version additionally renders any headers or footers.
	...
	/**
	 * Encodes the children of the data. This version wraps the table in a <code>tbody</code> element.
	 * @param context The JSF context.
	 * @param component The component being rendered.
	 * @throws IOException Thrown if there is an error writing the output.
	 * @throws NullPointerException Thrown if <var>context</var> or <var>component</var> is <code>null</code>.
	 ...
	 * @param columnCount The number of rendered columns for the column to cover. If <code>1</code> is specified, no attribute is given.
	 * @throws IOException Thrown if there is an error writing the output.
	 */
	 ...
	 * @throws IOException Thrown if there is an error writing the output.
	 */
	protected void encodeCell(final FacesContext context, final ResponseWriter writer, final UIComponent facet, final String elementName, final int columnCount)
			throws IOException {
