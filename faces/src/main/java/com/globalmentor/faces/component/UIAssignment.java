...
/**
 * Represents an assignment to a variable of a value. The value may be an object or, if a string, a value-binding extended JSF EL expression. Components
 * depending on this assignment should be included as children of this component. TODO add true variable scope by checking assignment status beforehand and
...
public class UIAssignment extends UIComponentBase {
	...
	/**
	 * Indicates that the assignment component renders its own children. This prevents other components from including or excluding the assignment children based
	 * upon their rendered status, which in turn may depend on the variable assignment in this component.
	 * @return <code>true</code> indicating that this component should determine child rendering.
	 */
	...
	/**
	 * Performs the component tree processing required by the <em>Apply Request Values</em> phase of the request processing lifecycle for all facets of this
	 * component, all children of this component, and this component itself. This version performs the requested assignment.
	 * @param context The JSF context for the request being processed.
	 * @throws NullPointerException if <code>context</code> is <code>null</code>, there is neither a value binding or a method binding, or there is no parameter
	 *           array for the method binding.
	 */
