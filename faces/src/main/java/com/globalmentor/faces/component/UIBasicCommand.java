...
/**
 * Basic command component with enhanced functionality. The command recognizes special parameters that control features of the command itself, rather than being
