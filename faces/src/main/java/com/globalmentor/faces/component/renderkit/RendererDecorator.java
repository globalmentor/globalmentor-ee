...
public class RendererDecorator extends Renderer {
	...
	protected String getComponentFamily() {
	...
	/**
	 * We'll cache whether the wrapped renderer renders children, as we can't double-check each time. We'll default to false.
	 */
	...
	/**
	 * Begins encoding the component. This version delegates to the wrapped renderer.
	 * @param context The JSF context.
	...
	/**
	 * Encodes the children of the component. This version delegates to the wrapped renderer.
	 * @param context The JSF context.
	 * @param component The component being rendered.
	 * @throws IOException Thrown if there is an error writing the output.
	 * @throws NullPointerException Thrown if <var>context</var> or <var>component</var> is <code>null</code>.
	...
	/**
	 * Encodes the end of the component. This version delegates to the wrapped renderer.
	 * @param context The JSF context.
	 * @param component The component being rendered.
	 * @throws IOException Thrown if there is an error writing the output.
	 * @throws NullPointerException Thrown if <var>context</var> or <var>component</var> is <code>null</code>.
	...
	/**
	 * Converts the component-generated client ID to a form suitable for transmission to the client. This version delegates to the wrapped renderer.
	 * @param context The JSF context.
	 * @param clientID The client identifier to be converted to client a specific format.
	 * @throws NullPointerException if <var>context</var> or <var>clientID</var> is <code>null</code>.
	 */
	...
	/**
	 * @return A flag indicating whether this renderer is responsible for rendering the children the component it is asked to render. This returns the value from
	 *         the most recent wrapped renderer, or <code>false</code> if no wrapped renderer has yet been retrieved.
	 */
	...
	/**
	 * Attempt to convert previously stored state information into an object of the type required for this component. This version delegates to the wrapped
	 * renderer.
	 * @param context The JSF context.
