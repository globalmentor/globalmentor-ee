...
public class FacesRender {
	...
	/**
	 * Renders attributes of the component that should be passed through with no modification.
	...
	public static void renderPassthroughAttributes(final ResponseWriter writer, final UIComponent component, final String[] attributes) throws IOException {
		final Map<String, Object> attributeMap = component.getAttributes(); //get the map of component attributes
	 ...
	 * <p>
	 * Inspired by the HTML code tutorial at <a href="http://www.htmlcodetutorial.com/linking/linking_famsupp_70.html"
	 * http://www.htmlcodetutorial.com/linking/linking_famsupp_70.html</a>.
	 * </p>
	 * @param writer The writer rendering the component.
	 * @param component The component being rendered.
	 * @param attributes The names of the attributes to render
