...
*/
	...
	*/
	...
	{
		final UIGraphic graphic=(UIGraphic)createComponent(application, UIGraphic.COMPONENT_TYPE, FacesContext.getCurrentInstance().getViewRoot().createUniqueId());	//create a graphic component
	...
	*/
	...
	{
		final UIParameter parameter=(UIParameter)createComponent(application, UIParameter.COMPONENT_TYPE, FacesContext.getCurrentInstance().getViewRoot().createUniqueId());	//create a parameter component
	...
	*/
	...
	{
		final UIParameterFormat parameter=(UIParameterFormat)createComponent(application, UIParameterFormat.COMPONENT_TYPE, FacesContext.getCurrentInstance().getViewRoot().createUniqueId());	//create a parameter component
		setStringValue(parameter, NAME_ATTRIBUTE, name);	//store the name, creating a value binding if necessary
		setStringValue(parameter, VALUE_ATTRIBUTE, value);	//store the value, creating a value binding if necessary
		return parameter;	//return the component
	}
	...
	*/
	...
	{
		final UISelectItem selectItem=(UISelectItem)createComponent(application, UISelectItem.COMPONENT_TYPE, FacesContext.getCurrentInstance().getViewRoot().createUniqueId());	//create a parameter component
	...
	*/
	...
	{
		final UISelectItems selectItems=(UISelectItems)createComponent(application, UISelectItems.COMPONENT_TYPE, FacesContext.getCurrentInstance().getViewRoot().createUniqueId());	//create a parameter component
